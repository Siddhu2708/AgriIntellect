...
def load_tomato_model():
    ...
    model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "https://github.com/Siddhu2708/Tomato-System-/blob/c21e4e861420c42ae7190c01335abdf4a91d10fd/tomato_disease_model.h5")
    try:
